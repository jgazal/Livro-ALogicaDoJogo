...
import br.com.cd.lj.tetris.base.CenarioPadrao;
import br.com.cd.lj.tetris.base.Texto;
...
public class JogoCenario extends CenarioPadrao {
	...
	public void carregar() {
		...
		try {
			as = AudioSystem.getAudioInputStream(new File("/home/jgazal/eclipse-workspace/LogicaDoJogo/Cap05-Tetris/som/adiciona_peca.wav"));
			clipAdicionarPeca = AudioSystem.getClip();
			clipAdicionarPeca.open(as);

			as = AudioSystem.getAudioInputStream(new File("/home/jgazal/eclipse-workspace/LogicaDoJogo/Cap05-Tetris/som/109662_grunz_success.wav"));
			clipMarcarLinha = AudioSystem.getClip();
			clipMarcarLinha.open(as);

			seqSomDeFundo = MidiSystem.getSequencer();
			seqSomDeFundo.setSequence(MidiSystem.getSequence(new File("/home/jgazal/eclipse-workspace/LogicaDoJogo/Cap05-Tetris/som/piano_quebrado.wav")));
			seqSomDeFundo.open();
