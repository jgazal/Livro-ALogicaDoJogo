package br.com.cd.lj.pacmanpizza;

import java.awt.Color;
import java.awt.Graphics2D;
import java.util.Random;
import javax.swing.ImageIcon;
import br.com.cd.lj.pacmanpizza.Legume.Modo;
import br.com.cd.lj.pacmanpizza.base.CenarioPadrao;
import br.com.cd.lj.pacmanpizza.base.Elemento;
import br.com.cd.lj.pacmanpizza.base.Texto;
import br.com.cd.lj.pacmanpizza.base.Util;
...
public class JogoCenario extends CenarioPadrao {
	...
	private final ImageIcon azeitona = new ImageIcon("/home/jgazal/eclipse-workspace/LogicaDoJogo/Cap07-PacManPizza/imagens/azeitona.png");
	private final ImageIcon pepperoni = new ImageIcon("/home/jgazal/eclipse-workspace/LogicaDoJogo/Cap07-PacManPizza/imagens/pepperoni.png");
	private final ImageIcon cenario = new ImageIcon("/home/jgazal/eclipse-workspace/LogicaDoJogo/Cap07-PacManPizza/imagens/tiles_cenario.png");
	private int largEl;
	public static final int ESPACO_TOPO = 25; // Espaçamento topo
	...
	public void reiniciar() {
		...
		// Voce pode guardar as posicoes iniciais em cada elemento ou refazer o loop
		for (int lin = 0; lin < grade.length; lin++) {
			for (int col = 0; col < grade[0].length; col++) {
	...
	private void atualizaDirecaoInimigos(Legume el) {
		...
		if (el.getModo() == Legume.Modo.PRESO) {
			...
			if (temporizadorFantasma > 50) {
				temporizadorFantasma = 0; // Faz os inimigos sairem em tempos diferentes
