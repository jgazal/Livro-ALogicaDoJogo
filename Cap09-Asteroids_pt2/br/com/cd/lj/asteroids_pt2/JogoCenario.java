package br.com.cd.lj.asteroids_pt2;
...
import br.com.cd.lj.asteroids_pt2.base.CenarioPadrao;
import br.com.cd.lj.asteroids_pt2.base.Elemento;
import br.com.cd.lj.asteroids_pt2.base.MatUtil;
import br.com.cd.lj.asteroids_pt2.base.Texto;
import br.com.cd.lj.asteroids_pt2.base.Util;
...
public class JogoCenario extends CenarioPadrao {
	...
	public void desenhar(Graphics2D g) {
		...
		texto.desenha(g, "Nave 1 | " + navJogUm.getPontos(), 10, 20);
		texto.desenha(g, "Nave 2 | " + navJogDois.getPontos(), largura - 120, 20);
